            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    @else
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('register') }}"><i class="bi bi-person-plus"></i> Sign Up</a>
                        </li>
                    @endauth
                </ul>
            </div>
        ...
        <div class="d-flex">
            ...
            <nav class="sidebar" id="sidebar">
                <div class="ps-2 pe-2">
                    ...
                    <a href="{{ route('reports.current-stock') }}" class="nav-link {{ request()->routeIs('reports.current-stock') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('reports.stock-summary') }}" class="nav-link {{ request()->routeIs('reports.stock-summary') ? 'active' : '' }}">
