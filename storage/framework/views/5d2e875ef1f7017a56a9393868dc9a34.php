            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('register')); ?>"><i class="bi bi-person-plus"></i> Sign Up</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
...
<?php /**PATH D:\Inventory_Management_System\inventory-management-system\resources\views/layouts/base.blade.php ENDPATH**/ ?>