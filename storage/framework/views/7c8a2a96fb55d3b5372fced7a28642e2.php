...
unset($__errorArgs, $__bag); ?>" 
                        ...
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($product->id); ?>" <?php echo e(old('product_id') == $product->id ? 'selected' : ''); ?>>
                                <?php echo e($product->name); ?> (<?php echo e($product->sku); ?>) - Current: <?php echo e($product->quantity_on_hand); ?> <?php echo e($product->unit); ?>
...
unset($__errorArgs, $__bag); ?>" 
                              id="remarks" name="remarks" rows="3"><?php echo e(old('remarks')); ?></textarea>
...
<?php echo $__env->make('layouts.base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Inventory Management System\inventory-system\resources\views/stock/stock-in.blade.php ENDPATH**/ ?>